...
# New constants for streamlined training process
AUTOTUNING_STREAMLINED_TRAINING = "streamlined_training"
AUTOTUNING_STREAMLINED_TRAINING_DEFAULT = False

AUTOTUNING_DEEPSPEED_HE_INTEGRATION = "deepspeed_he_integration"
AUTOTUNING_DEEPSPEED_HE_INTEGRATION_DEFAULT = False
